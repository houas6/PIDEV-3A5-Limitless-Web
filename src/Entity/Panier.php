 ...
 * Panier
 *
 * @ORM\Table(name="panier", indexes={@ORM\Index(name="id_user", columns={"id_user"}), @ORM\Index(name="id_produit", columns={"id_produit"})})
 * @ORM\Entity
...
class Panier
{
    ...
    public function setQuantiteProduct(int $quantiteProduct): self
    {
