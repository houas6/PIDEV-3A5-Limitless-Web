...
class ReponseReclamationController extends AbstractController
{
    ...
    public function appshow(
        ...
        return $this->render('reponse_reclamation/app.html.twig', [
            'reclamations' => $reclamationRepository->findBy([
                'reponseReclamation' => $id,
            ]),
        ]);
    }
    ...
    public function index_pdf(
        ...
        $logo = file_get_contents(
            'C:\Users\achra\Desktop\Reclamation\public\img\product-7.jpg '
        );
    ...
    public function sendEmail(
        ...
        $mailContent =
            ...
            "																							style=\"color:#2190e3;font-size:34px;\">" .
            $reponse .
            ...
            "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n" .
            "																			<span\n" .
            "																				style=\"font-size:18px;color:#000000;\"><br>Details:<br> Company name : " .
            'AutoDoc' .
            "</span>\n" .
            "																		</p>\n" .
            "																		<p\n" .
