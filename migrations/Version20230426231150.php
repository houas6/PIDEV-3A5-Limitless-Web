 ...
 */
final class Version20230426231150 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE panier (id_user INT NOT NULL, id_produit INT NOT NULL, quantite_product INT NOT NULL, INDEX id_produit (id_produit), INDEX id_user (id_user), PRIMARY KEY(id_user)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
